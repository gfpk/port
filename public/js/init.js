...
skel.init({
	reset: 'full',
	breakpoints: {
		global:		{ range: '*', href: (baseUrl+'/css/ze-style.css'), containers: 1100, grid: { gutters: 50 } },
		wide:		{ range: '-1680', href: (baseUrl+'/css/style-wide.css'), containers: 960, grid: { gutters: 40 } },
		normal:		{ range: '-1280', href: (baseUrl+'/css/style-normal.css'), containers: 960, lockViewport: true },
		...
		mobile:		{ range: '-640', href: (baseUrl+'/css/style-mobile.css'), containers: '100%', grid: { gutters: 15, collapse: 2 } }
	}
}, {
	layers: {
...
$( document ).ready(function() {
	var slideRotator =
    {
        init: function()
        {
            ...
            var currentItem = 0;
            var related = $("#jumbotext .inter").length;
            

            $("#jumbotext .inter").animate({ 
